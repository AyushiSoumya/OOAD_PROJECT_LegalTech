                ...
                <div class="row">
                  <div class="col-sm-6 image">
                    <div class="item">
                      ...
                      <h2><p class="cr4"> <br/>"The future of law is not lawyers;<br/> it's lawyers plus technology."<br/> - Daniel Katz</p>
                      </h2>
                    </div><!--enditem-->
                  </div><!--endcol-->
                  <div class="col-sm-6">
                    ...
                    <div class="details">
                      <h2 class="cr3"> About Us</h2>
                      <p class="cr4"> <br/>Legal technology, also known as Legal Tech,<br/> refers to the use of technology and software to provide<br/> legal services and support the legal industry.</p>
            ...
            <div class="row">
              <div class="col-sm-6 image">
                <div class="item">
                  ...
                  <p class="cr1"><br/>"Technology is a tool to enhance the practice of law,<br/> not replace it."<br/> - Dennis Kennedy</s></p>
              ...
              <div class="col-sm-6">
                ...
                <div class="details">
                 ...
                 <h2>A legal management system is a comprehensive software application designed to streamline and automate the day-to-day operations<br/> of law firms and legal departments. It offers a centralized platform for managing tasks, documents, time and billing,<br/> and client communication, thereby improving efficiency and increasing profitability.</h2>
      ...
      <div class="carousel-item">
          <div class="container text-center">
            <div class="row">
              <div class="col-sm-6 image">
                <div class="item">
                  <h1><p class="cr1">"<br/>Legal tech is not just about automating legal tasks; <br/>it's about reimagining how legal work is done." <br/>- Alma Asay
</s></p></h1>
              ...
              <div class="col-sm-6">
                ...
                <div class="details">
                  <h2 class="cr3"></h2>
                  <p class="cr4">>>CASE MANAGEMENT<br/>>>DOCUMENT MANAGEMENT<br/>>>CLIENT MANAGEMENT</p>
