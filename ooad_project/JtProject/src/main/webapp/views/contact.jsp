...
<header>
	<div class="overlay" bgcolor="#000000">
<center><h2>Book Appointments </h2></center>
<style>
h2 {
...
<form action="https://formcarry.com/s/Pq3xf4Lbabh" method="POST">
        <table class="tab2" width="40%" align="center" bgcolor="#808080">
            <tr>
                <td><br></td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="15%" align="left">
                    <font size="4">
                        &nbsp;Specialization of lawyers:</font>
                </td>
                <td width="25%" align="left"><input type="text" name="spec"> </td>
            </tr>
            <tr>
                <td width="15%" align="left">
                    <font size="4">
            ...
            <tr>
                <td align="center" colspan="2">
                    <br><button type="submit">
                        <font size="5" face="arial">Book Appointment</font>
                    </button>
                </td>
            </tr>
            <tr>
